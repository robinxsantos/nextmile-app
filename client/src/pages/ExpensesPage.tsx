...
export default function ExpensesPage() {
  ...
  useEffect(() => { if (admin) initApp(); }, [initApp, admin]);
  useEffect(() => { if (admin) fetchExpenses(); }, [fetchExpenses, expensesMonth, admin]);
  useEffect(() => { if (admin) fetchExpenseCategories(); }, [fetchExpenseCategories, selectedTruck, admin]);
